...
export default function ImposterGame() {
  ...
  { common: 'Chocolate', imposter: 'Candy' },
  { common: 'Milk', imposter: 'Juice' },
  { common: 'Clock', imposter: 'Watch' },
  { common: 'Shampoo', imposter: 'Soap' },
  { common: 'Bridge', imposter: 'Tunnel' },
  { common: 'Desert', imposter: 'Oasis' },
  { common: 'Planet', imposter: 'Star' },
  { common: 'Music', imposter: 'Dance' },

  // Marathi Words (50+)
  { common: 'पाणी', imposter: 'दूध' },
  { common: 'सूर्य', imposter: 'चंद्र' },
  { common: 'आई', imposter: 'वडील' },
  { common: 'भाऊ', imposter: 'बहीण' },
  { common: 'शाळा', imposter: 'कॉलेज' },
  { common: 'गाव', imposter: 'शहर' },
  { common: 'घर', imposter: 'झोपडी' },
  { common: 'रस्ता', imposter: 'पूल' },
  { common: 'झाड', imposter: 'फुल' },
  { common: 'डोंगर', imposter: 'टेकडी' },
  { common: 'नदी', imposter: 'ओढा' },
  { common: 'आकाश', imposter: 'जमीन' },
  { common: 'हवा', imposter: 'पाऊस' },
  { common: 'सिंह', imposter: 'वाघ' },
  { common: 'गाय', imposter: 'म्हैस' },
  { common: 'मासा', imposter: 'कोळंबी' },
  { common: 'घड्याळ', imposter: 'कॅलेंडर' },
  { common: 'पुस्तक', imposter: 'वृत्तपत्र' },
  { common: 'भात', imposter: 'पाव' },
  { common: 'साखर', imposter: 'मीठ' },
  { common: 'भाजी', imposter: 'फळ' },
  { common: 'दूध', imposter: 'ताक' },
  { common: 'चहा', imposter: 'कॉफी' },
  { common: 'खेळ', imposter: 'गाणं' },
  { common: 'गाडी', imposter: 'सायकल' },
  { common: 'दादा', imposter: 'काका' },
  { common: 'आजोबा', imposter: 'आजी' },
  { common: 'मित्र', imposter: 'शत्रू' },
  { common: 'पंखा', imposter: 'लाईट' },
  { common: 'खिडकी', imposter: 'दरवाजा' },
  { common: 'आरसा', imposter: 'काच' },
  { common: 'दुकान', imposter: 'बाजार' },
  { common: 'उन्हाळा', imposter: 'हिवाळा' },
  { common: 'पाऊस', imposter: 'हिमवर्षाव' },
  { common: 'वारा', imposter: 'वादळ' },
  { common: 'भाकर', imposter: 'पोळी' },
  { common: 'कपडे', imposter: 'बूट' },
  { common: 'टोपी', imposter: 'स्कार्फ' },
  { common: 'रुग्णालय', imposter: 'औषधालय' },
  { common: 'बस', imposter: 'ट्रेन' },
  { common: 'विमान', imposter: 'जहाज' },
  { common: 'समुद्र', imposter: 'तलाव' },
  { common: 'साखरपुडं', imposter: 'लग्न' },
  { common: 'महाल', imposter: 'किल्ला' },
  { common: 'भिंत', imposter: 'मजला' },
  { common: 'नोकरी', imposter: 'व्यवसाय' },
  { common: 'शेती', imposter: 'फॅक्टरी' },
  { common: 'हात', imposter: 'पाय' },
  { common: 'डोळे', imposter: 'कान' },
  { common: 'नाक', imposter: 'तोंड' },
  { common: 'फूल', imposter: 'पान' },
  { common: 'माती', imposter: 'वाळू' },
  { common: 'भाकर', imposter: 'भजी' },
  { common: 'सायकल', imposter: 'मोटार' },
  { common: 'शेतकरी', imposter: 'कामगार' },
  { common: 'सैनिक', imposter: 'पोलीस' },
  { common: 'पेन', imposter: 'खडू' },
  // 🌊 Konkan / Malvan related
  { common: 'समुद्र', imposter: 'तलाव' },
  { common: 'मालवण', imposter: 'रत्नागिरी' },
  { common: 'सिंधुदुर्ग', imposter: 'जंजिरा' },
  { common: 'किल्ला', imposter: 'महाल' },
  { common: 'वाळू', imposter: 'माती' },
  { common: 'मासे', imposter: 'कोळंबी' },
  { common: 'हापूस', imposter: 'पायरी' },
  { common: 'नारळ', imposter: 'सुपारी' },
  { common: 'फणस', imposter: 'आंबा' },
  { common: 'ताडी', imposter: 'दारू' },
  { common: 'कोकण', imposter: 'विदर्भ' },
  { common: 'गाव', imposter: 'शहर' },
  { common: 'पन्हाळा', imposter: 'राजगड' },
  { common: 'नौका', imposter: 'जहाज' },
  { common: 'वाडा', imposter: 'बंगला' },
  { common: 'शेती', imposter: 'कारखाना' },
  { common: 'कोकम', imposter: 'लिंबू' },
  { common: 'सोलकढी', imposter: 'ताक' },
  { common: 'तांदूळ', imposter: 'ज्वारी' },
  { common: 'गावकरी', imposter: 'शहरवासी' },

  // 👩 Ladies / Women related
  { common: 'साडी', imposter: 'ड्रेस' },
  { common: 'चुडी', imposter: 'बांगडी' },
  { common: 'कुंकू', imposter: 'मेंदी' },
  { common: 'गजरा', imposter: 'फूल' },
  { common: 'ओढणी', imposter: 'स्कार्फ' },
  { common: 'झुमका', imposter: 'माळा' },
  { common: 'मंगलसूत्र', imposter: 'हार' },
  { common: 'पायघड्या', imposter: 'पैंजण' },
  { common: 'टिळा', imposter: 'बिंदी' },
  { common: 'लिपस्टिक', imposter: 'नेलपॉलिश' },
  { common: 'आरसा', imposter: 'कंगवा' },
  { common: 'भाकरी', imposter: 'पोळी' },
  { common: 'लाडू', imposter: 'मोदक' },
  { common: 'सुगंधीतेल', imposter: 'काजळ' },
  { common: 'सोन्याची बांगडी', imposter: 'चांदीची बांगडी' },
  { common: 'चप्पल', imposter: 'सॅंडल' },
  { common: 'दुपट्टा', imposter: 'ओढणी' },
  { common: 'पर्स', imposter: 'पिशवी' },
  { common: 'घरकाम', imposter: 'शेतीकाम' },
  { common: 'आई', imposter: 'आज्जी' },
  { common: 'बहीण', imposter: 'मैत्रीण' },
  { common: 'सुहासिनी', imposter: 'मुलगी' },
  { common: 'अंगठी', imposter: 'गजरा' },
  { common: 'फुलांची माळ', imposter: 'गजरा' },
